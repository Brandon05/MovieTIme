...
class GridFlowLayout: UICollectionViewFlowLayout, UICollectionViewDelegateFlowLayout {
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewFlowLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let cell: GridCell = self.collectionView!.dequeueReusableCell(withReuseIdentifier: "cell1", for: indexPath) as! GridCell

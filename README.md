...
1. How to use Core Data with existing models
2. Protocol oriented approach to UICollectionView
3. How to use multiple collectionviews in the same view controller, like Netflix 

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/w9d62ko.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
